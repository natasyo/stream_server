...
export class ProfileResolver {
    ...
    @Mutation(() => Boolean)
    @Authorization()
    public async changeAvatar(@Authorized() user: User, @UploadParam('avatar') avatar: FileUpload) {
    ...
    @Authorization()
    @Mutation(() => Boolean)
    public async changeInfo(@Authorized() user: User, @Args('data') input: ChangeProfileInput) {
    ...
    @Authorization()
    @Mutation(() => Boolean)
    public async reorderSocialLink( @Args('list', {type: () => [SocialLinkOrderInput]}) input: SocialLinkOrderInput[]) {
    ...
    @Authorization()
    @Mutation(() => Boolean)
    public async removeSocialLink(@Args('id') id:string, @Args('data') input: SocialLinkInput) {
